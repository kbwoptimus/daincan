...
public class WxFoodController {
    ...
    public ResultVO list(@RequestParam("stid") int stid,
        ...
        return zuZhuang(foodList, stid);
    }

    public ResultVO zuZhuang(List<Food> foodList, int stid) {
        ...
        for (Leimu leimu : leimuList) {
            if (leimu.getStid().equals(stid)) {
                ...
                for (Food food : foodList) {
                    if (food.getStid().equals(stid) && food.getLeimuType().equals(leimu.getLeimuType())) {
