...
Page({
  ...
  onLoad: function(options) {
    ...
    //       storeName = sdataList.stname;
    //       storeIcon = sdataList.stimg;
  ...
  gotoOrder: function() {
    ...
    wx.navigateTo({
      url: '../confirmOrder/confirmOrder?&stname=' + this.data.stname + '&stimg=' + this.data.stimg
    })
  },
